        ...
        <div class="wrapper">
          ...
          <div class="header-item-right">
           ...
           <li class="nav-item dropdown m-none">
                    ...
                    <img src="assets/img/english.svg" whidth="20" class="px-2" alt="">  <span>EN</span>
                    </a>
                    <ul class="dropdown-menu langdrop" aria-labelledby="languageDropdown">
                        <li><a class="dropdown-item px-2" href="#"><img src="assets/img/english.svg" whidth="20" alt=""> <span class="px-2"> English</span></a></li>
                        <div class="dropdown-divider"></div>
                        <li><a class="dropdown-item px-2" href="#"><img src="assets/img/danish.svg" whidth="20" alt=""> <span  class="px-2">Danish</span></a></li>
                    </ul>
                </li>
