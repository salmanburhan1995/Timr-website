            ...
            <div class="row pt-5 px-4 justify-content-center align-items-center text-center">
                <div class="col-lg-12">
                    ...
                    <div class="d-flex justify-content-center align-items-center pt-4 pb-5 wow animate__animated animate__fadeInDown"> <img
                            src="assets/img/fi-rr-credit-card.svg" class="px-2" alt=""> No credit card required </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="abscard1 wow animate__animated animate__fadeIn">
                        <div class="card ex4 card-bx floaty">
                            <div class="card-body boxes1">
                                ...
                                <div class="">
                                    <img src="assets/img/graph-2.svg" stlye="width:90%" class="ps-5" alt="">
                                </div>
                            </div>
                        </div>
                        <img src="assets/img/dashboard.png" class="mx-auto wow animate__animated animate__fadeInUp" alt="">
                        <div class="abscard1 wow animate__animated animate__fadeIn">
                            <div class="card ex5 card-bx floaty">
                                <div class="card-body boxes1">
                                    ...
                                    <div>
                                        <img src="assets/img/graph-2.svg" class="ps-5" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card rounded-4 p-3 servicebox bx2">
                        <div class="card-body">
                            ...
                            <div class="listitem__img text-center">
                                <img src="assets/img/card-dashboard.png" width="460"
                    ...
                    <div class="card rounded-4 p-3 servicebox bx1">
                        <div class="card-body">
                            ...
                            <div class="listitem__img1 text-center">
                                <img src="assets/img/card-mobile.png" width="460" class="shadows1 text-center img-fluid"
                                    alt="services1">
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row pt-4 wow animate__animated animate__fadeInUp">
                <div class="col-lg-4 col-sm-12 services-box mb-3">
                    <div class="">
                        <img src="assets/img/key.svg" class="img-fluid" alt="dashboard">
                ...
                <div class="col-lg-4 col-sm-12 services-box mb-3">
                    <div class="">
                        <img src="assets/img/union.svg" class="img-fluid" alt="dashboard">
                ...
                <div class="col-lg-4 col-sm-12 services-box mb-3">
                    <div class="">
                        <img src="assets/img/candidate.svg" class="img-fluid" alt="dashboard">
                ...
                <div class="col-lg-4 mt-5">
                    <div class="reviews position-relative po-1">
                        <div class="reviews-one">
                            <div class="img-abs">
                                <img src="assets/img/t-1.svg" class="img-fluid rw-img" alt="">
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="reviews position-relative po-2">
                        <div class="reviews-one">
                            ...
                            <div class="img-abs2">
                                <img src="assets/img/t-2.svg" class="img-fluid rw-img" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row position-relative pt-5 wow animate__animated animate__fadeInUp">
                ...
                <div class="col-lg-4 mt-5">
                    <div class="reviews position-relative po-1">
                        <div class="reviews-one">
                            <div class="img-abs">
                                <img src="assets/img/t-3.svg" class="img-fluid rw-img" alt="">
                            </div>
                            <div class="card back-review">
                                <div class="card-body">
                    ...
                    <div class="card back-review">
                        <div class="card-body">
                            <div class="justify-content-center align-items-center">
                                <img src="assets/img/t-2.svg" width="52" class="img-fluid mb-3 mx-auto" alt="">
                    ...
                    <div class="card rounded-4 p-3 featureebox bxx2 bg-gr-1">
                        <div class="card-body">
                            ...
                            <div class="features__img text-center">
                                <img src="assets/img/invoicing.png" width="460" class="text-center img-fluid"
                                    alt="services1">
                            </div>
                        </div>
                    </div>
                            ...
                            <h2 class="f-24 fw-600 pt-2">Powerful visualizations for <br> clarity </h2>
                                <div class="card ex1 ">
                                    <div class="card-body boxes1">
                                        ...
                                        <div>
                                            <img src="assets/img/graph-1.svg" class="ps-5" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="card ex2 ">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 position-relative">
                            <img src="assets/img/timesheet.png" class="" alt="">
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="card wow animate__animated animate__fadeInRight">
                        <div class="card-body">
                            <img src="assets/img/list-2.png" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center align-items-center pt-5">
                <div class="col-lg-6  wow animate__animated animate__fadeInLeft">
                    <div class="card">
                        <div class="card-body">
                            <img src="assets/img/list-1.png" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
