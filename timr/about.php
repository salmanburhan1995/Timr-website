...
<section class="gap-80">
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center pt-4">
            <div class="col-lg-12">
                <img src="assets/img/about.svg" class="img-fluid mx-auto " width="100%" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center wow animate__animated animate__fadeInUp">
                ...
                <div class="col-lg-4 position-relative mb-3">
                    <div class="team">
                        <img src="assets/img/team/t-1.svg" class="img-fluid" alt="">
                        <div class="content">
                          <p>  Ammy Watson - CEO</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 position-relative mb-3">
                    <div class="team">
                        <img src="assets/img/team/t-2.svg" class="img-fluid" alt="">
                        <div class="content">
                          <p> Kenny Grey - COO</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 position-relative mb-3">
                    <div class="team">
                        <img src="assets/img/team/t-3.svg" class="img-fluid" alt="">
                        <div class="content">
                          <p> Ashley K - PM</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 position-relative mb-3">
                    <div class="team">
                        <img src="assets/img/team/t-4.svg" class="img-fluid" alt="">
                        <div class="content">
                          <p>  Joe Henry - PM</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 position-relative mb-3">
                    <div class="team">
                        <img src="assets/img/team/t-5.svg" class="img-fluid" alt="">
                        <div class="content">
