    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-5 px-5">
                ...
                <h2 class="fw-600 f-20 text-center">Verify Phone Number</h2>
                <p class="text-center">Enter the OTP Code to sent on +1234556789 to Continue</p>
                <form action="">
                    ...
                    <p class="f-18 fw-500">Didn't get the code <a href="#" style="color:purple">Resend</a></p>
