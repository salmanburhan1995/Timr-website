        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-5 px-5">
             <img src="{{ asset('frontend/assets/img/logo.svg') }}" class="img-fluid round mx-auto mb-3" alt="">
                <h2 class="fw-600 f-20 text-center">{{ translateContent('Verify Email', $translationService) }}</h2>
                <p class="text-center">{{ translateContent('Enter the OTP Code to sent on Jhonedeo@gmail.com to Continue', $translationService) }}</p>
                <form action="">
                    ...
                    <p class="f-18 fw-500">{{ translateContent("Didn't get the code", $translationService) }} <a href="#" style="color:purple">{{ translateContent('Resend', $translationService) }}</a></p>
