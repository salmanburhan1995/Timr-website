            ...
            <div class="row justify-content-center align-items-center">
              ...
              <div class="col-lg-1"></div>
                <div class="col-lg-5 px-5 mb-5">
                    ...
                    <h2 class="fw-600 f-20 text-center">Welcome Back</h2>
                    <p class="text-center f-18">We Missed You!</p>

                    <ul class="bynav nav nav-pills  justify-content-center align-items-center pt-5">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="pill" href="#home">Email</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="pill" href="#menu1">Phone Number</a>
                        </li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content mt-5">
                        <div class="tab-pane active" id="home">
                            <form action="">
                                ...
                                <button class="btn btn-primary btn-block mt-3 mb-4" style="width:100%">Sign In</button>
                                ...
                                <button
                                    ...
                                    style="width:100%"> <img src="{{ asset('frontend/assets/img/google.svg') }}" alt="">Sign In with
                                    Google</button>
                                <button
                                    class="btn btn-border btn-block mt-3 mb-4 d-flex justify-content-center align-item-center"
                                    style="width:100%"> <img src="{{ asset('frontend/assets/img/linkedin.svg') }}" alt="">Sign In with
                                    Linkedin</button>
                            </form>
                        </div>
